...
public final class DbReaderContract{
    ...
    public static abstract class UsersCardsDb implements BaseColumns{
        ...
        public static final String COLUMN_NAME_REGISTERED_BY = "registered_by";
    ...
    public static abstract class UsersDb implements BaseColumns{
        ...
        public static final String COLUMN_NAME_DATE_CREATED = "date_created";
        public static final String COLUMN_NAME_DEVICE_ID = "device_id"; //todo: prisijungiant tikrinti ar nepasikeite ir jei reikia atnaujinti
        public static final String COLUMN_NAME_USER_NAME = "user_name";
